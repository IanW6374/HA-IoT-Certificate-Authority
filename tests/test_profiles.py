...
class ProfileTests(unittest.TestCase):
    def test_hamd_request(self):
        result = validate_request(
            profile_slug="hamd",
            common_name="hamd-a1b2c3",
            sans="hamd-a1b2c3.home.arpa\n192.168.1.20",
            key_type="rsa-2048",
            validity_days=365,
            export_format="hamd",
            allowed_suffix="home.arpa",
        )
        self.assertEqual(result["sans"], ["hamd-a1b2c3.home.arpa", "192.168.1.20"])
    ...
    def test_hamd_requires_rsa(self):
        with self.assertRaisesRegex(IdentityError, "not allowed"):
            validate_request(
                profile_slug="hamd",
                common_name="hamd-test",
                sans="hamd-test.home.arpa",
                key_type="ec-p256",
                validity_days=365,
                export_format="hamd",
                allowed_suffix="home.arpa",
